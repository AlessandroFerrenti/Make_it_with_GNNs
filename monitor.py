...
class Monitor:
  ...
  def __init__(self):
    ...
    self.global_ctx_switches_count_init, self.global_interrupts_count_init, self.global_soft_interrupts_count_init = 0, 0, 0
  ...
  def get_sys_info(self):
    ...
    bandwidth_info = self.get_bandwidths(
        disk_info=disk_info, net_info=net_info)

    # remove the global counters
    del disk_info['disk/disk_read_sys_mb']
    del disk_info['disk/disk_write_sys_mb']
    del net_info['network/net_sent_sys_mb']
    del net_info['network/net_recv_sys_mb']
  ...
  def get_bandwidths(self, disk_info, net_info):
    ...
    return {
        'bandwidth/disk_read_sys_bandwidth_mbs': disk_read_sys_bandwidth_mbs, 'bandwidth/disk_write_sys_bandwidth_mbs': disk_write_sys_bandwidth_mbs, 'bandwidth/net_sent_sys_bandwidth_mbs': net_sent_sys_bandwidth_mbs, 'bandwidth/net_recv_sys_bandwidth_mbs': net_recv_sys_bandwidth_mbs
    }
  ...
  def get_cpu_info(self):
    ...
    global_ctx_switches_count, global_interrupts_count, global_soft_interrupts_count, _ = psutil.cpu_stats()
    ctx_switches_count = global_ctx_switches_count - \
        self.global_ctx_switches_count_init
    interrupts_count = global_interrupts_count - self.global_interrupts_count_init
    soft_interrupts_count = global_soft_interrupts_count - \
    ...
    return {
        'cpu/logical_core_count': logical_core_count, 'cpu/interrupts/ctx_switches_count': ctx_switches_count, 'cpu/interrupts/interrupts_count': interrupts_count, 'cpu/interrupts/soft_interrupts_count': soft_interrupts_count, 'cpu/load/avg_sys_load_one_min_percent': avg_sys_load_one_min_percent, 'cpu/load/avg_sys_load_five_min_percent': avg_sys_load_five_min_percent, 'cpu/load/avg_sys_load_fifteen_min_percent': avg_sys_load_fifteen_min_percent
    }
  ...
  def get_memory_info():
    ...
    total_b, available_b, used_memory_sys_percent, used_b, _, _, _, _, _, _, _ = psutil.virtual_memory()
    total_memory_sys_mb = total_b / 1024**2
    available_memory_sys_mb = available_b / 1024**2
    used_memory_sys_mb = used_b / 1024**2

    return {
        'memory/total_memory_sys_mb': total_memory_sys_mb, 'memory/available_memory_sys_mb': available_memory_sys_mb, 'memory/used_memory_sys_mb': used_memory_sys_mb, 'memory/used_memory_sys_percent': used_memory_sys_percent
    }
  ...
  def get_process_info():
    ...
    rss_b, vms_b, shared_b, trs_b, drs_b, lib_b, dirty_pages_proc_count = proc.memory_info()
    resident_set_size_proc_mb = rss_b / 1024**2
    virtual_memory_size_proc_mb = vms_b / 1024**2
    shared_memory_proc_mb = shared_b / 1024**2
    text_resident_set_proc_mb = trs_b / 1024**2
    data_resident_set_proc_mb = drs_b / 1024**2
    lib_memory_proc_mb = lib_b / 1024**2

    return {
        'process/voluntary_proc_ctx_switches': voluntary_proc_ctx_switches, 'process/involuntary_proc_ctx_switches': involuntary_proc_ctx_switches, 'process/memory/resident_set_size_proc_mb': resident_set_size_proc_mb, 'process/memory/virtual_memory_size_proc_mb': virtual_memory_size_proc_mb, 'process/memory/shared_memory_proc_mb': shared_memory_proc_mb, 'process/memory/text_resident_set_proc_mb': text_resident_set_proc_mb, 'process/memory/data_resident_set_proc_mb': data_resident_set_proc_mb, 'process/memory/lib_memory_proc_mb': lib_memory_proc_mb, 'process/memory/dirty_pages_proc_count': dirty_pages_proc_count
    }
  ...
  def get_disk_info(self):
    ...
    global_disk_read_sys_count, global_disk_write_sys_count, \
        global_disk_read_sys_bytes, global_disk_write_sys_bytes, \
        global_disk_read_time_sys_ms, global_disk_write_time_sys_ms, \
        _, _, global_busy_time_sys_ms = psutil.disk_io_counters()

    disk_read_sys_mb = global_disk_read_sys_bytes / 1024**2
    disk_write_sys_mb = global_disk_write_sys_bytes / 1024**2
    ...
    disk_read_time_sys_s = global_disk_read_time_sys_ms / \
        1000 - self.disk_read_time_sys_s_init
    disk_write_time_sys_s = global_disk_write_time_sys_ms / \
        1000 - self.disk_write_time_sys_s_init
    disk_busy_time_sys_s = global_busy_time_sys_ms / \
        1000 - self.disk_busy_time_sys_s_init

    return {
        'disk/counter/disk_read_sys_count': disk_read_sys_count, 'disk/counter/disk_write_sys_count': disk_write_sys_count, 'disk/disk_read_sys_mb': disk_read_sys_mb, 'disk/disk_write_sys_mb': disk_write_sys_mb, 'disk/time/disk_read_time_sys_s': disk_read_time_sys_s, 'disk/time/disk_write_time_sys_s': disk_write_time_sys_s, 'disk/time/disk_busy_time_sys_s': disk_busy_time_sys_s
    }
  ...
  def get_network_info():
    ...
    net_sent_sys_bytes, net_recv_sys_bytes, _, _, _, _, _, _ = psutil.net_io_counters(
        pernic=False)
    net_sent_sys_mb = net_sent_sys_bytes / 1024**2
    net_recv_sys_mb = net_recv_sys_bytes / 1024**2

    return {
        'network/net_sent_sys_mb': net_sent_sys_mb, 'network/net_recv_sys_mb': net_recv_sys_mb
    }
